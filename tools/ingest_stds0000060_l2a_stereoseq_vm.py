...
TASK_ID = "t_2abc4811"
URL = "https://ftp.cngb.org/pub/SciRAID/stomics/STDS0000060/stomics/L2_a_count_normal_stereoseq.h5ad"
FILENAME = "L2_a_count_normal_stereoseq.h5ad"
PREFIX = "temporal_pretraining/stomics/STDS0000060_drosophila_stereoseq/L2_a_count_normal_stereoseq"
PRIOR_PREFIXES = [
    ...
    "temporal_pretraining/stomics/STDS0000060_drosophila_stereoseq/L3_b_count_normal_stereoseq",
]
ARTIFACT_JSON = ROOT / "artifacts/schema_audit/stds0000060_L2_a_lamin_ingestion_20260704.json"
ARTIFACT_MD = ROOT / "artifacts/schema_audit/stds0000060_L2_a_lamin_ingestion_20260704.md"
EXPECTED_HOST = "pert-gym-worker-eu"
EXPECTED_LENGTH = 7390373028
...
def enrich_obs(obs: pd.DataFrame) -> pd.DataFrame:
    ...
    obs["sample"] = "L2_a_count_normal_stereoseq"
    obs["developmental_stage"] = "L2"
...
def write_triplet(ln: Any, h5ad_path: Path, obs: pd.DataFrame, var: pd.DataFrame) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="stds0000060_l2a_") as td:
...
def write_reports(out: dict[str, Any]) -> None:
    ...
    lines = [
        "# STDS0000060 L2_a Stereo-seq Lamin ingestion report",
        "",
...
def main() -> None:
    ...
    p.add_argument("--work-dir", type=Path, default=Path("data/vm_stage/stds0000060/L2_a"))
    ...
    if args.write:
        ln.track(path="tools/ingest_stds0000060_l2a_stereoseq_vm.py")
