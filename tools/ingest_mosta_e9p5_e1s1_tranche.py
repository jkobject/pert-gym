#!/usr/bin/env python3
"""Register the MOSTA/STDS0000058 E9.5_E1S1 next exact-clear small-file triplet.

Guarded for Kanban t_094a548a. Runs only on pert-gym-worker-eu. Current tranche is exactly one next exact-clear already-staged small H5AD,
E9.5_E1S1, chosen per Kanban t_094a548a after accepted E9.5_E2S1; next exact-clear per reviewer duplicate probe.
"""
...
REPORT_JSON = ROOT / f"artifacts/schema_audit/mosta_E9p5_E1S1_tranche_{DATE}.json"
REPORT_MD = ROOT / f"artifacts/schema_audit/mosta_E9p5_E1S1_tranche_{DATE}.md"
...
TRANCHE = [
    {
        ...
        "stage": "E9.5",
        "section": "E1S1",
        "source_uri": "gs://scperturb/pert-gym/staging/temporal_pretraining/mosta_stds0000058_20260703/stomics/E9.5_E1S1.MOSTA.h5ad",
        "prefix": "temporal_pretraining/mosta_stds0000058/E9.5_E1S1",
        "expected_gcs_size_bytes": 463449741,
        "local_source": "/tmp/pert-gym-mosta-tranche/E9.5_E1S1.MOSTA.h5ad",
    }
]
...
def write_reports(report: dict[str, Any]) -> None:
    ...
    lines = [
        "# MOSTA E9.5_E1S1 next exact-clear small-file triplet report",
        "",
        ...
        "",
        "## Scope",
        "- One next exact-clear already-staged H5AD: `E9.5_E1S1.MOSTA.h5ad`.",
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        ...
        "tranche": TRANCHE,
        "commands": [
            "uv run python tools/ingest_mosta_e9p5_e1s1_tranche.py --dry-run",
            "uv run python tools/ingest_mosta_e9p5_e1s1_tranche.py --write",
            "uv run python tools/ingest_mosta_e9p5_e1s1_tranche.py --verify-only",
        ],
        "lamin": {
    ...
    if not args.verify_only:
        ln.track(path="tools/ingest_mosta_e9p5_e1s1_tranche.py")
