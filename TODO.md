...
| OBS continuation | **ONGOING — 8/70 datasets, 33/640 base-public component×fields, and 6 outside-universe component×fields accepted** | `SchiebingerLander2019` remains latest accepted. `GSE197452` producer `t_05cef992` is review-pending: OBS `6UsaktwOJjkXPM3L0003`, additions successor `ZTXfvA5YDoaqrd750000`, exact 20,811×33,694 source/X parity, replay no-op; no counter credit before independent acceptance. GSE213921 is frozen after rejection 3/3 and must not be auto-rerun | Other additions may advance the dataset counter after review, but never the frozen base-public `/640` metric |
