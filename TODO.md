...
_Last verified: 2026-07-22 20:45 CEST from the `pert-gym` Kanban board, accepted product-delta ledger, and immutable reviewer handoffs. Pending writers are never counted before independent acceptance._
...
| Real datasets with ≥1 independently accepted OBS recovery | **10/70** | 60 | current-main accepted ledger, including GSE197452 and Datlinger17; GSE150062 itself remains pending independent acceptance and receives no anticipatory credit |
...
| VAR dataset remediations independently accepted | **8/70** | 62 | accepted-ledger truth at the GSE150062 retry gate; GSE150062 itself remains pending independent acceptance and receives no anticipatory credit |
...
| OBS continuation | **ONGOING — 10/70 datasets, 33/640 base-public component×fields, and 6 outside-universe component×fields accepted** | Current-main accepted history includes the independently accepted GSE197452 and Datlinger17 outcomes. GSE150062 remains pending independent acceptance and receives no anticipatory credit; GSE213921 is frozen after rejection 3/3 and must not be auto-rerun | Other additions may advance the dataset counter after review, but never the frozen base-public `/640` metric |
| VAR remediation | **ONGOING — 8/70 accepted by the strict ledger** | Current-main accepted history is preserved. GSE150062 remains pending independent acceptance and receives no anticipatory credit | Continue one stable real-dataset identity at a time; conserve 70 datasets / 120 families / 1,056 members and keep residual false/unknown/not-applicable verdicts honest |
...
The strict accepted OBS ledger is **10/70 real datasets**. The accepted history includes DRUG-seq, Ginkgo/VCPI, LINCS phase 2, Datlinger17, Chang22, depmap_ccle/26q1, `scperturb/adamson16`, `SchiebingerLander2019`, and the current-main accepted GSE197452 outcome; the authoritative product ledger owns the remaining accepted identity. Datlinger17 revision `0003` remains accepted on exact 5,905-row parity and six fields, while `perturbation_type` and `x_semantics` remain explicitly absent. GSE197452 retains exact 20,811×33,694 source/X parity, OBS `6UsaktwOJjkXPM3L0003`, additions successor `ZTXfvA5YDoaqrd750000`, and replay no-op evidence. The frozen base-public assignment counter remains **33/640**, plus six accepted DepMap assignments outside that universe. GSE150062 remains pending independent acceptance and contributes no counter delta in this PR.
...
The strict accepted VAR ledger is **8/70** at the GSE150062 retry gate. The previously documented named snapshot reached 6/70 through `scperturb/adamson16` and `SchiebingerLander2019`; the authoritative product ledger owns the two later accepted identities. GSE150062 remains pending independent acceptance and contributes no counter delta in this PR. Its candidate boundary is explicit rather than fabricated: 44,025 source-backed ENSG features, 16,401 source-native custom `LH` features for which exact ENSG assignment is `not_applicable`, and 71 unresolved applicable features retained as `unknown`.
