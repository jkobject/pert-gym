...
_Last verified: 2026-07-21 21:48 CEST from the `pert-gym` Kanban board, accepted product-delta ledger, and immutable reviewer handoffs. Pending writers are never counted before independent acceptance._
...
| Real datasets with ≥1 independently accepted OBS recovery | **7/70** | 63 | latest: `scperturb/adamson16`; reviewer `t_b40b3f73`, zero-write readback SHA-256 `b645b6cc…`, mismatch 0 |
...
| VAR dataset remediations independently accepted | **5/70** | 65 | latest: `scperturb/adamson16`; reviewer `t_b40b3f73`, zero-write readback SHA-256 `b645b6cc…`, mismatch 0; SchiebingerLander2019 remains pending |
...
| OBS continuation | **ONGOING — 7/70 datasets, 33/640 base-public component×fields, and 6 outside-universe component×fields accepted** | `scperturb/adamson16` reviewer `t_b40b3f73` PASS; GSE213921 is frozen after rejection 3/3 and must not be auto-rerun | Other additions may advance the dataset counter after review, but never the frozen base-public `/640` metric |
| VAR remediation | **ONGOING — 5/70 accepted by the strict ledger** | `scperturb/adamson16` reviewer `t_b40b3f73` PASS; GSE207360/run 4073, LINCS phase1/run 4094, and SchiebingerLander2019 remain pending conforming exact-once acceptance | Continue one stable real-dataset identity at a time; conserve 70 datasets / 120 families / 1,056 members and keep residual false/unknown verdicts honest |
