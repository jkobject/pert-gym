#!/usr/bin/env python3
"""Update PRISM P5F status/progress artifacts after verified GSE283614 ingestion."""
...
DATASET = "GSE283614"
SOURCE_URI = "gs://scperturb/pert-gym/staging/data/main/prism_google_drive_datasets_20260622/GSE283614.h5ad"
SOURCE_BYTES = 1_514_297_474
VERIFICATION_JSON = "artifacts/schema_audit/prism_GSE283614_chunked_verification.json"
SOURCE_PROBE_JSON = "artifacts/schema_audit/prism_GSE283614_source_probe_20260623.json"
CHUNK_SIZE = 1000
PREFIX = f"prism_collection/{DATASET}"
NEXT_CANDIDATE = "GSE280767"
...
def main() -> int:
    ...
    assert verification["chunks_verified"] == 13
    assert verification["rows_verified"] == 12844
    assert verification["expected_vars"] == 33586
    ...
    status["remaining"].update(
        {
            ...
            "single_staged_smoke_first_candidates_remaining_estimate": 16,
            "total_accessible_candidates_remaining_estimate": 16,
    ...
    note = (
        "2026-06-23 t_278787d2: GSE283614 ingested from staged Google Drive h5ad "
        "as 13 backed CSR chunks (chunk_size=1000), verified obs->X->var links, X payloads, "
        "12,844 rows, 33,586 vars, and required obs fields."
    )
    ...
    upsert_by_dataset(
        progress.setdefault("ingested", []),
        {
            "dataset": DATASET,
            "prefix": PREFIX,
            "path": "data/gcs_cache/scperturb/pert-gym/staging/data/main/prism_google_drive_datasets_20260622/GSE283614.h5ad",
            "gcs_uri": SOURCE_URI,
    ...
    inventory_rel = "artifacts/schema_audit/prism_p5f_cont10_inventory_20260623.json"
