#!/usr/bin/env python3
"""Update PRISM P5F status/progress artifacts after verified GSE269596 ingestion."""
...
SOURCE_BYTES = 2_505_068_264
VERIFICATION_JSON = "artifacts/schema_audit/prism_GSE269596_chunked_verification.json"
SOURCE_PROBE_JSON = "artifacts/schema_audit/prism_GSE269596_source_probe_20260623.json"
CHUNK_SIZE = 1000
PREFIX = f"prism_collection/{DATASET}"
NEXT_CANDIDATE = "GSE281048_TGFB_Perturb_seq"
...
def main() -> int:
    ...
    status["remaining"].update(
        {
            ...
            "single_staged_smoke_first_candidates_remaining_estimate": 14,
            "total_accessible_candidates_remaining_estimate": 14,
    ...
    upsert_by_dataset(
        progress.setdefault("ingested", []),
        {
            "dataset": DATASET,
            "prefix": PREFIX,
            "path": "data/gcs_cache/scperturb/pert-gym/staging/data/main/prism_google_drive_datasets_20260622/GSE269596.h5ad",
            "gcs_uri": SOURCE_URI,
    ...
    inventory_rel = "artifacts/schema_audit/prism_p5f_cont12_inventory_20260623.json"
