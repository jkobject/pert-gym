#!/usr/bin/env python3
"""Recompute the PRISM P5F residual inventory for cont10.
...
GCS_LS = ROOT / "artifacts/schema_audit/prism_p5f_cont10_gcs_h5ad_ls_20260623.txt"
STATUS_JSON = ROOT / "artifacts/schema_audit/prism_p5f_status_20260622.json"
OUT_JSON = ROOT / "artifacts/schema_audit/prism_p5f_cont10_inventory_20260623.json"
OUT_MD = ROOT / "artifacts/schema_audit/prism_p5f_cont10_inventory_20260623.md"
...
def main() -> int:
    ...
    md = ["# PRISM P5F cont10 inventory — 2026-06-23\n\n"]
