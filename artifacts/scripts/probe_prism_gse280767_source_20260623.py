#!/usr/bin/env python3
"""Backed probe for staged PRISM GSE280767 without loading the full matrix."""
...
EXPECTED_BYTES = 2_010_340_238
OUT = ROOT / "artifacts/schema_audit/prism_GSE280767_source_probe_20260623.json"
