#!/usr/bin/env python3
"""Backed probe for staged PRISM GSE283614 without loading the full matrix."""
...
from tools.gcs_cache import ensure_gcs_object_local
...
EXPECTED_BYTES = 1_514_297_474
OUT = ROOT / "artifacts/schema_audit/prism_GSE283614_source_probe_20260623.json"
