# PRISM P5F cont10 inventory — 2026-06-23

Recomputed from the current GCS staging listing and visible Lamin triplet keys on branch `jkobject`; no Lamin writes and no X matrix loads. This file was then updated after the selected candidate (`GSE283614`) passed smoke/full ingestion and verification.

- GCS h5ad objects: 33
- GCS h5ad bytes: 99139295837
- Completed datasets: 14
- Accessible smoke-first candidates: 16
- Staged payload issues: 1
- Missing/source-blocked: 5
- User-excluded: 1
- Newly completed this run: `GSE283614`
- Next candidate: `GSE280767`

## Remaining candidates by current GCS size

| dataset | bytes | uri |
| --- | ---: | --- |
| GSE280767 | 2010340238 | `gs://scperturb/pert-gym/staging/data/main/prism_google_drive_datasets_20260622/GSE280767.h5ad` |
| GSE269596 | 2505068264 | `gs://scperturb/pert-gym/staging/data/main/prism_google_drive_datasets_20260622/GSE269596.h5ad` |
